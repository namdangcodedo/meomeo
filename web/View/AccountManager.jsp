...
<body class="skin-black">
    ...
    <!-- Search Text Field -->
        ...
        <select name="sortBy">
            <c:forEach items="${sortOptions}" var="option">
                <option value="${option}">${option}</option>
            </c:forEach>
        </select>

        <!-- Add New Button -->
        <button type="button" onclick="location.href='addNew.jsp';">Add new</button>
        ...
        <tbody>           
                <tr>
                    ...
                    <td class="action-buttons">
                        <a href="AccountDetails.jsp">View</a>
                         <a href="ViewProfile_1.jsp">Edit</a>
                      <a href="edit/${user.id}">Delete</a>
                    </td>
