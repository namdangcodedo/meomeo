...
<body class="skin-black">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
     ...
     <div class="container">
         <button>BACK</button>
         <h1>Chi tiết đơn hàng - #1234</h1>

    <div class="invoice-header">
        
        <div class="" style="margin-right: 50">
            <h3>Thông tin đơn hàng</h3>
            <p>ID đơn hàng: #1234</p>
            <p>Tên khách hàng: Đào Ngọc Nam</p>
            <p>Email: namdn25012003@gmail.com</p>
            <p>Ngày đặt: 07/06/2024</p>
            <p>Nơi nhận hàng: Số nhà 83 tổ 9 thị trấn Mường chà Tính Điện Biên</p>
 ...
 <h2>Sản phẩm</h2>
    ...
    <h2>Tổng số tiền</h2>
        ...
        <tr>
            <td colspan="4">Trạng thái thanh toán</td>
            <td>Đã thanh toán</td>
        </tr>
        <tr>
            <td colspan="4">Ngày thanh toán</td>
            <td>10/06/2024</td>
        </tr>
